...
window.RS_DATA = {
  ...
  rest: [
    ...
    { id: 'andrea-klemova',    n: 10, name: 'Andrea Klemová',    role: 'produktová manažerka' },
    { id: 'dominik-bren',      n: 11, name: 'Dominik Břeň',      role: 'psycholog, spoluzakladatel startupu' },
    { id: 'martina-machova',   n: 12, name: 'Martina Machová',   role: 'personální ředitelka' },
    { id: 'simon-babicek',     n: 13, name: 'Šimon Babíček',     role: 'student' },
    ...
    { id: 'libor-halman',      n: 18, name: 'Libor Halman',      role: 'OSVČ' },
    { id: 'eliska-csajkova',   n: 19, name: 'Eliška Csajková',   role: 'v důchodu, dříve OSVČ' },
